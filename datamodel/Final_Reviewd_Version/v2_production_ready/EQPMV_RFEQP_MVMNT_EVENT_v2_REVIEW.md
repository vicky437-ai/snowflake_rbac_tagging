# Code Review: EQPMV_RFEQP_MVMNT_EVENT v2 — Production Deployment Review
**Review Date:** March 15, 2026  
**Reviewer:** Cortex Code (Independent Review)  
**Script:** v2_production_ready/EQPMV_RFEQP_MVMNT_EVENT_v2.sql  
...
| Primary Key | RFEQP_MVMNT_EVENT_ID (Single) |
...
4. Verify: `CALL D_RAW.SADB.SP_PROCESS_EQPMV_RFEQP_MVMNT_EVENT()`
5. Monitor: `SELECT * FROM D_BRONZE.MONITORING.CDC_EXECUTION_LOG WHERE TABLE_NAME = 'EQPMV_RFEQP_MVMNT_EVENT' ORDER BY CREATED_AT DESC LIMIT 10`
