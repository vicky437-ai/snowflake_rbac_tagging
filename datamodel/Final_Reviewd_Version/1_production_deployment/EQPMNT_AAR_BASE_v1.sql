...
BEGIN
    ...
    -- =========================================================================
    BEGIN
        SELECT SYSTEM$STREAM_GET_STALE_AFTER('D_RAW.SADB.EQPMNT_AAR_BASE_BASE_HIST_STREAM') INTO v_stale_after;
...
CREATE OR REPLACE TASK D_RAW.SADB.TASK_PROCESS_EQPMNT_AAR_BASE
    ...
    COMMENT = 'Task to process EQPMNT_AAR_BASE_BASE CDC changes into data preservation table (v1 - enhanced logging)'
AS
...
-- CALL D_RAW.SADB.SP_PROCESS_EQPMNT_AAR_BASE();
-- SELECT * FROM D_BRONZE.MONITORING.CDC_EXECUTION_LOG WHERE TABLE_NAME = 'EQPMNT_AAR_BASE' ORDER BY CREATED_AT DESC LIMIT 10;
