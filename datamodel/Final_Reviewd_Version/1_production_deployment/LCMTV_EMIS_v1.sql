...
BEGIN
    ...
    -- =========================================================================
    BEGIN
        SELECT SYSTEM$STREAM_GET_STALE_AFTER('D_RAW.SADB.LCMTV_EMIS_BASE_HIST_STREAM') INTO v_stale_after;
...
CREATE OR REPLACE TASK D_RAW.SADB.TASK_PROCESS_LCMTV_EMIS
    ...
    COMMENT = 'Task to process LCMTV_EMIS_BASE CDC changes into data preservation table (v1 - enhanced logging)'
AS
...
-- CALL D_RAW.SADB.SP_PROCESS_LCMTV_EMIS();
-- SELECT * FROM D_BRONZE.MONITORING.CDC_EXECUTION_LOG WHERE TABLE_NAME = 'LCMTV_EMIS' ORDER BY CREATED_AT DESC LIMIT 10;
