...
BEGIN
    ...
    -- =========================================================================
    BEGIN
        SELECT SYSTEM$STREAM_GET_STALE_AFTER('D_RAW.SADB.TRKFCG_FIXED_PLANT_ASSET_BASE_HIST_STREAM') INTO v_stale_after;
...
CREATE OR REPLACE TASK D_RAW.SADB.TASK_PROCESS_TRKFCG_FIXED_PLANT_ASSET
    ...
    COMMENT = 'Task to process TRKFCG_FIXED_PLANT_ASSET_BASE CDC changes into data preservation table (v1 - enhanced logging)'
AS
...
-- CALL D_RAW.SADB.SP_PROCESS_TRKFCG_FIXED_PLANT_ASSET();
-- SELECT * FROM D_BRONZE.MONITORING.CDC_EXECUTION_LOG WHERE TABLE_NAME = 'TRKFCG_FIXED_PLANT_ASSET' ORDER BY CREATED_AT DESC LIMIT 10;
