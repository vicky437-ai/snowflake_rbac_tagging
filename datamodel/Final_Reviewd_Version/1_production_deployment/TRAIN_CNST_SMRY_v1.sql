...
BEGIN
    ...
    -- =========================================================================
    BEGIN
        SELECT SYSTEM$STREAM_GET_STALE_AFTER('D_RAW.SADB.TRAIN_CNST_SMRY_BASE_HIST_STREAM') INTO v_stale_after;
...
CREATE OR REPLACE TASK D_RAW.SADB.TASK_PROCESS_TRAIN_CNST_SMRY
    ...
    COMMENT = 'Task to process TRAIN_CNST_SMRY_BASE CDC changes into data preservation table (v1 - enhanced logging)'
AS
...
-- CALL D_RAW.SADB.SP_PROCESS_TRAIN_CNST_SMRY();
-- SELECT * FROM D_BRONZE.MONITORING.CDC_EXECUTION_LOG WHERE TABLE_NAME = 'TRAIN_CNST_SMRY' ORDER BY CREATED_AT DESC LIMIT 10;
