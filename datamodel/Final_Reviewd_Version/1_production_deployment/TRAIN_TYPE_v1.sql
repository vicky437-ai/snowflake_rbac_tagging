...
Task         : D_RAW.SADB.TASK_PROCESS_TRAIN_TYPE
...
BEGIN
    ...
    -- =========================================================================
    BEGIN
        SELECT SYSTEM$STREAM_GET_STALE_AFTER('D_RAW.SADB.TRAIN_TYPE_BASE_HIST_STREAM') INTO v_stale_after;
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_PROCESS_TRAIN_TYPE
    WAREHOUSE = INFA_INGEST_WH
    SCHEDULE = '5 MINUTE'
    ALLOW_OVERLAPPING_EXECUTION = FALSE
    COMMENT = 'Task to process TRAIN_TYPE_BASE CDC changes into data preservation table (v1 - enhanced logging)'
AS
    CALL D_RAW.SADB.SP_PROCESS_TRAIN_TYPE();

ALTER TASK D_RAW.SADB.TASK_PROCESS_TRAIN_TYPE RESUME;
...
-- SHOW TASKS LIKE 'TASK_PROCESS_TRAIN_TYPE%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRAIN_TYPE();
-- SELECT * FROM D_BRONZE.MONITORING.CDC_EXECUTION_LOG WHERE TABLE_NAME = 'TRAIN_TYPE' ORDER BY CREATED_AT DESC LIMIT 10;
