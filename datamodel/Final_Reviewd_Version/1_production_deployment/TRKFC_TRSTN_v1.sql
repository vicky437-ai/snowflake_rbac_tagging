...
Task         : D_RAW.SADB.TASK_PROCESS_TRKFC_TRSTN
...
BEGIN
    ...
    -- =========================================================================
    BEGIN
        SELECT SYSTEM$STREAM_GET_STALE_AFTER('D_RAW.SADB.TRKFC_TRSTN_BASE_HIST_STREAM') INTO v_stale_after;
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_PROCESS_TRKFC_TRSTN
    WAREHOUSE = INFA_INGEST_WH
    SCHEDULE = '5 MINUTE'
    ALLOW_OVERLAPPING_EXECUTION = FALSE
    COMMENT = 'Task to process TRKFC_TRSTN_BASE CDC changes into data preservation table (v1 - enhanced logging)'
AS
...
-- SHOW TASKS LIKE 'TASK_PROCESS_TRKFC_TRSTN%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRKFC_TRSTN();
-- SELECT * FROM D_BRONZE.MONITORING.CDC_EXECUTION_LOG WHERE TABLE_NAME = 'TRKFC_TRSTN' ORDER BY CREATED_AT DESC LIMIT 10;
