...
Task         : D_RAW.SADB.TASK_PROCESS_TRAIN_OPTRN_LEG
...
BEGIN
    ...
    -- =========================================================================
    BEGIN
        SELECT SYSTEM$STREAM_GET_STALE_AFTER('D_RAW.SADB.TRAIN_OPTRN_LEG_BASE_HIST_STREAM') INTO v_stale_after;
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_PROCESS_TRAIN_OPTRN_LEG
    WAREHOUSE = INFA_INGEST_WH
    SCHEDULE = '5 MINUTE'
    ALLOW_OVERLAPPING_EXECUTION = FALSE
    COMMENT = 'Task to process TRAIN_OPTRN_LEG_BASE CDC changes into data preservation table (v1 - enhanced logging)'
AS
    CALL D_RAW.SADB.SP_PROCESS_TRAIN_OPTRN_LEG();

ALTER TASK D_RAW.SADB.TASK_PROCESS_TRAIN_OPTRN_LEG RESUME;
...
-- SHOW TASKS LIKE 'TASK_PROCESS_TRAIN_OPTRN_LEG%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRAIN_OPTRN_LEG();
-- SELECT * FROM D_BRONZE.MONITORING.CDC_EXECUTION_LOG WHERE TABLE_NAME = 'TRAIN_OPTRN_LEG' ORDER BY CREATED_AT DESC LIMIT 10;
