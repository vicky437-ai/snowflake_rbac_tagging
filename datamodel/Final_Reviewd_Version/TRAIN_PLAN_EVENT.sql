...
Total Columns: 36 source + 6 CDC metadata = 42
================================================================================
*/
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS D_BRONZE.SADB.TRAIN_PLAN_EVENT (
...
BEGIN
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        USING (
            ...
            FROM D_RAW.SADB.TRAIN_PLAN_EVENT_BASE src
            LEFT JOIN D_BRONZE.SADB.TRAIN_PLAN_EVENT tgt 
                ON src.TRAIN_PLAN_EVENT_ID = tgt.TRAIN_PLAN_EVENT_ID
            WHERE tgt.TRAIN_PLAN_EVENT_ID IS NULL
...
WHEN
    SYSTEM$STREAM_HAS_DATA('D_RAW.SADB.TRAIN_PLAN_EVENT_BASE_HIST_STREAM')
AS
