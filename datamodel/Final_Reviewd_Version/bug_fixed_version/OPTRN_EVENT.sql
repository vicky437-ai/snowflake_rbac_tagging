...
-- =============================================================================
CREATE OR ALTER TABLE D_BRONZE.SADB.OPTRN_EVENT (
...
-- =============================================================================
-- STEP 1.1: Set DEFAULT values (run after CREATE OR ALTER TABLE)
-- =============================================================================
ALTER TABLE D_BRONZE.SADB.OPTRN_EVENT ALTER COLUMN CDC_TIMESTAMP SET DEFAULT CURRENT_TIMESTAMP();
ALTER TABLE D_BRONZE.SADB.OPTRN_EVENT ALTER COLUMN IS_DELETED SET DEFAULT FALSE;
ALTER TABLE D_BRONZE.SADB.OPTRN_EVENT ALTER COLUMN RECORD_CREATED_AT SET DEFAULT CURRENT_TIMESTAMP();
ALTER TABLE D_BRONZE.SADB.OPTRN_EVENT ALTER COLUMN RECORD_UPDATED_AT SET DEFAULT CURRENT_TIMESTAMP();
