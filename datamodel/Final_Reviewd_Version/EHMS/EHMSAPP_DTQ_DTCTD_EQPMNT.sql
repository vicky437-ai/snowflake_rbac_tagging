/*
================================================================================
DATA PRESERVATION SCRIPT FOR D_RAW.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT_BASE
================================================================================
Source Table : D_RAW.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT_BASE
Target Table : D_BRONZE.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT
Stream       : D_RAW.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT_BASE_HIST_STREAM
Procedure    : D_RAW.EHMS.SP_PROCESS_EHMSAPP_DTQ_DTCTD_EQPMNT()
Task         : D_RAW.EHMS.TASK_PROCESS_EHMSAPP_DTQ_DTCTD_EQPMNT
...
-- =============================================================================
CREATE OR ALTER TABLE D_BRONZE.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT (
...
-- =============================================================================
ALTER TABLE D_RAW.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT_BASE 
...
-- =============================================================================
CREATE OR REPLACE STREAM D_RAW.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT_BASE_HIST_STREAM
ON TABLE D_RAW.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT_BASE
SHOW_INITIAL_ROWS = TRUE
COMMENT = 'CDC Stream for EHMSAPP_DTQ_DTCTD_EQPMNT_BASE data preservation. SHOW_INITIAL_ROWS=TRUE for initial load.';

-- =============================================================================
-- STEP 4: Create Stored Procedure for CDC Processing (ENHANCED v1)
-- =============================================================================
CREATE OR REPLACE PROCEDURE D_RAW.EHMS.SP_PROCESS_EHMSAPP_DTQ_DTCTD_EQPMNT()
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS
...
BEGIN
    ...
    BEGIN
        ...
        FROM D_RAW.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT_BASE_HIST_STREAM
        WHERE 1=0;
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        MERGE INTO D_BRONZE.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT AS tgt
        USING (
            SELECT 
                src.*,
                'INSERT' AS CDC_OP,
                :v_batch_id AS BATCH_ID
            FROM D_RAW.EHMS.EHMSAPP_DTQ_DTCTD_EQPMNT_BASE_HIST_STREAM src
        ) AS src
    ...
    -- =========================================================================
    CREATE OR REPLACE TEMPORARY TABLE _CDC_STAGING_EHMSAPP_DTQ_DTCTD_EQPMNT AS
    SELECT 
        DTCTD_EQPMNT_ID, CREATE_USER_ID, RECORD_CREATE_TMS, RECORD_UPDATE_TMS, UPDATE_USER_ID,
        DTCTD_TRAIN_ID, EQPMNT_SQNC_NBR, RPRTD_MARK_CD, RPRTD_EQPUN_NBR, RPRTD_AEI_RAW_DATA_TXT,
        RPRTD_AXLE_QTY, RPRTD_EQPMNT_CTGRY_TXT, RPRTD_EQPMNT_TYPE_CD, RPRTD_EQPMNT_ORNTN_CD, RPRTD_SPEED_QTY,
    ...
    SELECT COUNT(*) INTO v_staging_count FROM _CDC_STAGING_EHMSAPP_DTQ_DTCTD_EQPMNT;
    
    IF (v_staging_count = 0) THEN
        DROP TABLE IF EXISTS _CDC_STAGING_EHMSAPP_DTQ_DTCTD_EQPMNT;
        v_end_time := CURRENT_TIMESTAMP();
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (TABLE_NAME, BATCH_ID, EXECUTION_STATUS, START_TIME, END_TIME, ROWS_PROCESSED, ROWS_INSERTED, ROWS_UPDATED, ROWS_DELETED, ERROR_MESSAGE, CREATED_AT) VALUES ('EHMSAPP_DTQ_DTCTD_EQPMNT', :v_batch_id, 'NO_DATA', :v_start_time, :v_end_time, 0, 0, 0, 0, NULL, CURRENT_TIMESTAMP());
    ...
    FROM _CDC_STAGING_EHMSAPP_DTQ_DTCTD_EQPMNT;
...
EXCEPTION
    WHEN OTHER THEN
        ...
        v_error_msg := SQLERRM;
        DROP TABLE IF EXISTS _CDC_STAGING_EHMSAPP_DTQ_DTCTD_EQPMNT;
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (TABLE_NAME, BATCH_ID, EXECUTION_STATUS, START_TIME, END_TIME, ROWS_PROCESSED, ROWS_INSERTED, ROWS_UPDATED, ROWS_DELETED, ERROR_MESSAGE, CREATED_AT) VALUES ('EHMSAPP_DTQ_DTCTD_EQPMNT', :v_batch_id, 'ERROR', :v_start_time, :v_end_time, 0, 0, 0, 0, :v_error_msg, CURRENT_TIMESTAMP());
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.EHMS.TASK_PROCESS_EHMSAPP_DTQ_DTCTD_EQPMNT
    WAREHOUSE = INFA_INGEST_WH
    SCHEDULE = '5 MINUTE'
    ALLOW_OVERLAPPING_EXECUTION = FALSE
    COMMENT = 'Task to process EHMSAPP_DTQ_DTCTD_EQPMNT_BASE CDC changes into data preservation table'
AS
    CALL D_RAW.EHMS.SP_PROCESS_EHMSAPP_DTQ_DTCTD_EQPMNT();

ALTER TASK D_RAW.EHMS.TASK_PROCESS_EHMSAPP_DTQ_DTCTD_EQPMNT RESUME;

-- =============================================================================
-- VERIFICATION QUERIES
-- =============================================================================
-- SHOW TABLES LIKE 'EHMSAPP_DTQ_DTCTD_EQPMNT%' IN SCHEMA D_BRONZE.EHMS;
-- SHOW STREAMS LIKE 'EHMSAPP_DTQ_DTCTD_EQPMNT%' IN SCHEMA D_RAW.EHMS;
-- SHOW TASKS LIKE 'TASK_PROCESS_EHMSAPP_DTQ_DTCTD_EQPMNT%' IN SCHEMA D_RAW.EHMS;
-- CALL D_RAW.EHMS.SP_PROCESS_EHMSAPP_DTQ_DTCTD_EQPMNT();
