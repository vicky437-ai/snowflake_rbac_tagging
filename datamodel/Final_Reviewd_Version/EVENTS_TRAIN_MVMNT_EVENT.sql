...
Task         : D_RAW.AWS.TASK_PROCESS_EVENTS_TRAIN_MVMNT_EVENT
...
-- =============================================================================
CREATE TABLE IF NOT EXISTS D_BRONZE.AWS.EVENTS_TRAIN_MVMNT_EVENT (
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.AWS.TASK_PROCESS_EVENTS_TRAIN_MVMNT_EVENT
...
WHEN
    SYSTEM$STREAM_HAS_DATA('D_RAW.AWS.EVENTS_TRAIN_MVMNT_EVENT_BASE_HIST_STREAM')
AS
    CALL D_RAW.AWS.SP_PROCESS_EVENTS_TRAIN_MVMNT_EVENT();

ALTER TASK D_RAW.AWS.TASK_PROCESS_EVENTS_TRAIN_MVMNT_EVENT RESUME;
