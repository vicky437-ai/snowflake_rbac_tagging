...
DECLARE
    ...
    v_rows_deduped NUMBER DEFAULT 0;
    v_staging_raw_count NUMBER DEFAULT 0;
    v_result VARCHAR;
    v_error_msg VARCHAR;
...
BEGIN
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        -- Recovery MERGE with DEDUPLICATION (same ROW_NUMBER logic as normal mode)
        -- Picks latest record per PK using SNW_LAST_REPLICATED to handle
        -- duplicate rows that may exist in _BASE after IDMC reload
    ...
    -- =========================================================================
    -- CHECK 2: Stage stream data into temp table with DEDUPLICATION
    -- ROW_NUMBER() picks latest record per PK using SNW_LAST_REPLICATED
    -- =========================================================================
    ...
    -- =========================================================================
    -- PRE-MERGE METRICS (including dedup tracking)
    -- =========================================================================
    SELECT 
