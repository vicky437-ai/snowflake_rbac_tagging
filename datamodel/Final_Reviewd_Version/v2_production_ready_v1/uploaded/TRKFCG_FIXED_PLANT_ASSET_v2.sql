...
Task         : D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_FIXED_PLANT_ASSET
Primary Key  : GRPHC_OBJECT_VRSN_ID (Single)
Total Columns: 53 source + 6 CDC metadata = 59
...
-- =============================================================================
CREATE OR ALTER TABLE D_BRONZE.SADB.TRKFCG_FIXED_PLANT_ASSET (
...
COMMENT = 'Bronze data preservation layer for TRKFCG Fixed Plant Assets.
Source: Oracle SADB (TRKFCG_FIXED_PLANT_ASSET) replicated via IDMC CDC into D_RAW.SADB.TRKFCG_FIXED_PLANT_ASSET_BASE.
Data Source Tables: D_RAW.SADB.TRKFCG_FIXED_PLANT_ASSET_BASE (53 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.TRKFCG_FIXED_PLANT_ASSET_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_TRKFCG_FIXED_PLANT_ASSET() | Task D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_FIXED_PLANT_ASSET.
...
BEGIN
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        USING (
            ...
            FROM D_RAW.SADB.TRKFCG_FIXED_PLANT_ASSET_BASE_HIST_STREAM src
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'TRKFCG_FIXED_PLANT_ASSET', :v_batch_id, 'RECOVERY', :v_start_time, :v_end_time,
    ...
    IF (v_staging_count = 0) THEN
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'TRKFCG_FIXED_PLANT_ASSET', :v_batch_id, 'NO_DATA', :v_start_time, :v_end_time,
            0, 0, 0, 0,
    ...
    INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
        ...
        'TRKFCG_FIXED_PLANT_ASSET', :v_batch_id, 'SUCCESS', :v_start_time, :v_end_time,
...
EXCEPTION
    WHEN OTHER THEN
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'TRKFCG_FIXED_PLANT_ASSET', :v_batch_id, 'ERROR', :v_start_time, :v_end_time,
            0, 0, 0, 0,
            :v_error_msg, CURRENT_TIMESTAMP()
        );
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_FIXED_PLANT_ASSET
...
ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_FIXED_PLANT_ASSET RESUME;
...
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_TRKFCG_FIXED_PLANT_ASSET%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRKFCG_FIXED_PLANT_ASSET();
