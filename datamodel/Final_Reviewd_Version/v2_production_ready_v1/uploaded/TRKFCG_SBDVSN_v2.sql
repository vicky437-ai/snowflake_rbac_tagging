...
Task         : D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_SBDVSN
...
COMMENT = 'Bronze data preservation layer for Track Configuration Subdivisions.
Source: Oracle SADB (TRKFCG_SBDVSN) replicated via IDMC CDC into D_RAW.SADB.TRKFCG_SBDVSN_BASE.
Data Source Tables: D_RAW.SADB.TRKFCG_SBDVSN_BASE (50 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.TRKFCG_SBDVSN_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_TRKFCG_SBDVSN() | Task D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_SBDVSN.
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_SBDVSN
    WAREHOUSE = INFA_INGEST_WH
    SCHEDULE = '5 MINUTE'
    ALLOW_OVERLAPPING_EXECUTION = FALSE
    COMMENT = 'Task to process TRKFCG_SBDVSN_BASE CDC changes into data preservation table '
AS
    CALL D_RAW.SADB.SP_PROCESS_TRKFCG_SBDVSN();

ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_SBDVSN RESUME;
...
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_TRKFCG_SBDVSN%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRKFCG_SBDVSN();
