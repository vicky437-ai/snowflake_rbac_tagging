...
Task         : D_RAW.SADB.TASK_SP_PROCESS_EQPMNT_AAR_BASE
Primary Key  : EQPMNT_ID (Single)
Total Columns: 82 source + 6 CDC metadata = 88
...
-- =============================================================================
CREATE OR ALTER TABLE D_BRONZE.SADB.EQPMNT_AAR_BASE (
...
COMMENT = 'Bronze data preservation layer for Equipment AAR Base.
Source: Oracle SADB (EQPMNT_AAR_BASE) replicated via IDMC CDC into D_RAW.SADB.EQPMNT_AAR_BASE_BASE.
Data Source Tables: D_RAW.SADB.EQPMNT_AAR_BASE_BASE (82 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.EQPMNT_AAR_BASE_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_EQPMNT_AAR_BASE() | Task D_RAW.SADB.TASK_SP_PROCESS_EQPMNT_AAR_BASE.
...
BEGIN
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        USING (
            ...
            FROM D_RAW.SADB.EQPMNT_AAR_BASE_BASE_HIST_STREAM src
        ...
        WHEN NOT MATCHED THEN INSERT (
            ...
            RGSTRN_REASON_CD, RSTNCL_PRGRM_CD, TRUCK_QTY, RATE_CD, SNW_OPERATION_TYPE,
            SNW_OPERATION_OWNER, SNW_LAST_REPLICATED,
            ...
            src.RGSTRN_REASON_CD, src.RSTNCL_PRGRM_CD, src.TRUCK_QTY, src.RATE_CD, src.SNW_OPERATION_TYPE,
            src.SNW_OPERATION_OWNER, src.SNW_LAST_REPLICATED,
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'EQPMNT_AAR_BASE', :v_batch_id, 'RECOVERY', :v_start_time, :v_end_time,
    ...
    IF (v_staging_count = 0) THEN
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'EQPMNT_AAR_BASE', :v_batch_id, 'NO_DATA', :v_start_time, :v_end_time,
            0, 0, 0, 0,
...
EXCEPTION
    WHEN OTHER THEN
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'EQPMNT_AAR_BASE', :v_batch_id, 'ERROR', :v_start_time, :v_end_time,
            0, 0, 0, 0,
            :v_error_msg, CURRENT_TIMESTAMP()
        );
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_EQPMNT_AAR_BASE
...
ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_EQPMNT_AAR_BASE RESUME;


-- =============================================================================
-- VERIFICATION QUERIES
-- =============================================================================
-- SHOW TABLES LIKE 'EQPMNT_AAR_BASE%' IN SCHEMA D_BRONZE.SADB;
-- SHOW STREAMS LIKE 'EQPMNT_AAR_BASE%' IN SCHEMA D_RAW.SADB;
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_EQPMNT_AAR_BASE%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_EQPMNT_AAR_BASE();
