...
Task         : D_RAW.SADB.TASK_SP_PROCESS_TRAIN_PLAN
...
COMMENT = 'Bronze data preservation layer for Train Plans.
Source: Oracle SADB (TRAIN_PLAN) replicated via IDMC CDC into D_RAW.SADB.TRAIN_PLAN_BASE.
Data Source Tables: D_RAW.SADB.TRAIN_PLAN_BASE (18 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.TRAIN_PLAN_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_TRAIN_PLAN() | Task D_RAW.SADB.TASK_SP_PROCESS_TRAIN_PLAN.
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_TRAIN_PLAN
    WAREHOUSE = INFA_INGEST_WH
    SCHEDULE = '5 MINUTE'
    ALLOW_OVERLAPPING_EXECUTION = FALSE
    COMMENT = 'Task to process TRAIN_PLAN_BASE CDC changes into data preservation table '
AS
    CALL D_RAW.SADB.SP_PROCESS_TRAIN_PLAN();

ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_TRAIN_PLAN RESUME;
...
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_TRAIN_PLAN%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRAIN_PLAN();
