...
Task         : D_RAW.SADB.TASK_SP_PROCESS_LCMTV_MVMNT_EVENT
...
COMMENT = 'Bronze data preservation layer for Locomotive Movement Events.
Source: Oracle SADB (LCMTV_MVMNT_EVENT) replicated via IDMC CDC into D_RAW.SADB.LCMTV_MVMNT_EVENT_BASE.
Data Source Tables: D_RAW.SADB.LCMTV_MVMNT_EVENT_BASE (44 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.LCMTV_MVMNT_EVENT_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_LCMTV_MVMNT_EVENT() | Task D_RAW.SADB.TASK_SP_PROCESS_LCMTV_MVMNT_EVENT.
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_LCMTV_MVMNT_EVENT
...
ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_LCMTV_MVMNT_EVENT RESUME;
...
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_LCMTV_MVMNT_EVENT%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_LCMTV_MVMNT_EVENT();
