...
Task         : D_RAW.SADB.TASK_SP_PROCESS_TRAIN_KIND
...
COMMENT = 'Bronze data preservation layer for Train Kind Reference.
Source: Oracle SADB (TRAIN_KIND) replicated via IDMC CDC into D_RAW.SADB.TRAIN_KIND_BASE.
Data Source Tables: D_RAW.SADB.TRAIN_KIND_BASE (11 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.TRAIN_KIND_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_TRAIN_KIND() | Task D_RAW.SADB.TASK_SP_PROCESS_TRAIN_KIND.
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_TRAIN_KIND
...
ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_TRAIN_KIND RESUME;
...
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_TRAIN_KIND%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRAIN_KIND();
