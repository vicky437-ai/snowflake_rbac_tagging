...
Task         : D_RAW.SADB.TASK_SP_PROCESS_TRAIN_PLAN_EVENT
...
COMMENT = 'Bronze data preservation layer for Train Plan Events.
Source: Oracle SADB (TRAIN_PLAN_EVENT) replicated via IDMC CDC into D_RAW.SADB.TRAIN_PLAN_EVENT_BASE.
Data Source Tables: D_RAW.SADB.TRAIN_PLAN_EVENT_BASE (37 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.TRAIN_PLAN_EVENT_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_TRAIN_PLAN_EVENT() | Task D_RAW.SADB.TASK_SP_PROCESS_TRAIN_PLAN_EVENT.
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_TRAIN_PLAN_EVENT
    WAREHOUSE = INFA_INGEST_WH
    SCHEDULE = '5 MINUTE'
    ALLOW_OVERLAPPING_EXECUTION = FALSE
    COMMENT = 'Task to process TRAIN_PLAN_EVENT_BASE CDC changes into data preservation table '
AS
    CALL D_RAW.SADB.SP_PROCESS_TRAIN_PLAN_EVENT();

ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_TRAIN_PLAN_EVENT RESUME;
...
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_TRAIN_PLAN_EVENT%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRAIN_PLAN_EVENT();
