...
Task         : D_RAW.SADB.TASK_SP_PROCESS_EQPMV_EQPMT_EVENT_TYPE
...
COMMENT = 'Bronze data preservation layer for Equipment Movement Event Types.
Source: Oracle SADB (EQPMV_EQPMT_EVENT_TYPE) replicated via IDMC CDC into D_RAW.SADB.EQPMV_EQPMT_EVENT_TYPE_BASE.
Data Source Tables: D_RAW.SADB.EQPMV_EQPMT_EVENT_TYPE_BASE (25 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.EQPMV_EQPMT_EVENT_TYPE_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_EQPMV_EQPMT_EVENT_TYPE() | Task D_RAW.SADB.TASK_SP_PROCESS_EQPMV_EQPMT_EVENT_TYPE.
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_EQPMV_EQPMT_EVENT_TYPE
...
ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_EQPMV_EQPMT_EVENT_TYPE RESUME;
...
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_EQPMV_EQPMT_EVENT_TYPE%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_EQPMV_EQPMT_EVENT_TYPE();
