/*
================================================================================
DATA PRESERVATION SCRIPT FOR D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE
================================================================================
Source Table : D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE
Target Table : D_BRONZE.SADB.SHPMT_STNWYB_MSG_DN
Stream       : D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE_HIST_STREAM
Procedure    : D_RAW.SADB.SP_PROCESS_SHPMT_STNWYB_MSG_DN()
Task         : D_RAW.SADB.TASK_SP_PROCESS_SHPMT_STNWYB_MSG_DN
...
-- =============================================================================
CREATE OR ALTER TABLE D_BRONZE.SADB.SHPMT_STNWYB_MSG_DN (
...
COMMENT = 'Bronze data preservation layer for STAWYB message.
Source: Oracle SADB (SHPMT_STNWYB_MSG_DN) replicated via IDMC CDC into D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE.
Data Source Tables: D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE (131 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_SHPMT_STNWYB_MSG_DN() | Task D_RAW.SADB.TASK_SP_PROCESS_SHPMT_STNWYB_MSG_DN.
...
-- =============================================================================
ALTER TABLE D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE 
...
-- =============================================================================
CREATE OR REPLACE STREAM D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE_HIST_STREAM
ON TABLE D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE
SHOW_INITIAL_ROWS = TRUE
COMMENT = 'CDC Stream for SHPMT_STNWYB_MSG_DN_BASE data preservation. SHOW_INITIAL_ROWS=TRUE for initial load.';

-- =============================================================================
-- STEP 4: Create Stored Procedure for CDC Processing
-- =============================================================================
CREATE OR REPLACE PROCEDURE D_RAW.SADB.SP_PROCESS_SHPMT_STNWYB_MSG_DN()
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS
...
BEGIN
    ...
    BEGIN
            ...
            FROM D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE_HIST_STREAM
            WHERE 1=0;
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        MERGE INTO D_BRONZE.SADB.SHPMT_STNWYB_MSG_DN AS tgt
        USING (
            SELECT 
                src.*,
                'INSERT' AS CDC_OP,
                :v_batch_id AS BATCH_ID
            FROM D_RAW.SADB.SHPMT_STNWYB_MSG_DN_BASE_HIST_STREAM src
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'SHPMT_STNWYB_MSG_DN', :v_batch_id, 'RECOVERY', :v_start_time, :v_end_time,
    ...
    -- =========================================================================
    CREATE OR REPLACE TEMPORARY TABLE _CDC_STAGING_SHPMT_STNWYB_MSG_DN AS
    SELECT 
        STNWYB_MSG_VRSN_ID, RECORD_CREATE_TMS, CREATE_USER_ID, RECORD_UPDATE_TMS, UPDATE_USER_ID,
        CRNT_VRSN_CD, SOURCE_CREATE_TMS, SRVASG_EQPMT_ASGNMN_ID, SRVASG_SHPSRV_ITEM_SHPMT_ID, SRVASG_SHPSRV_ITEM_SQNC_NBR,
        SRVASG_SQNC_NBR, SHPSRV_EQPASG_CD, CYCLE_SERIAL_NBR, WYBL_NBR, WYBL_CREATE_LOCAL_TMS,
    ...
    SELECT COUNT(*) INTO v_staging_count FROM _CDC_STAGING_SHPMT_STNWYB_MSG_DN;
    
    IF (v_staging_count = 0) THEN
        DROP TABLE IF EXISTS _CDC_STAGING_SHPMT_STNWYB_MSG_DN;
        v_end_time := CURRENT_TIMESTAMP();
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'SHPMT_STNWYB_MSG_DN', :v_batch_id, 'NO_DATA', :v_start_time, :v_end_time,
            0, 0, 0, 0,
    ...
    FROM _CDC_STAGING_SHPMT_STNWYB_MSG_DN;
    ...
    INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
        ...
        'SHPMT_STNWYB_MSG_DN', :v_batch_id, 'SUCCESS', :v_start_time, :v_end_time,
...
EXCEPTION
    WHEN OTHER THEN
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'SHPMT_STNWYB_MSG_DN', :v_batch_id, 'ERROR', :v_start_time, :v_end_time,
            0, 0, 0, 0,
            :v_error_msg, CURRENT_TIMESTAMP()
        );
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_SHPMT_STNWYB_MSG_DN
    WAREHOUSE = INFA_INGEST_WH
    SCHEDULE = '5 MINUTE'
    ALLOW_OVERLAPPING_EXECUTION = FALSE
    COMMENT = 'Task to process SHPMT_STNWYB_MSG_DN_BASE CDC changes into data preservation table '
AS
    CALL D_RAW.SADB.SP_PROCESS_SHPMT_STNWYB_MSG_DN();

ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_SHPMT_STNWYB_MSG_DN RESUME;


-- =============================================================================
-- VERIFICATION QUERIES
-- =============================================================================
-- SHOW TABLES LIKE 'SHPMT_STNWYB_MSG_DN%' IN SCHEMA D_BRONZE.SADB;
-- SHOW STREAMS LIKE 'SHPMT_STNWYB_MSG_DN%' IN SCHEMA D_RAW.SADB;
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_SHPMT_STNWYB_MSG_DN%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_SHPMT_STNWYB_MSG_DN();
