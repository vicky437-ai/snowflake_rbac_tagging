...
Task         : D_RAW.SADB.TASK_SP_PROCESS_TRAIN_CNST_SMRY
Primary Key  : COMPOSITE (TRAIN_CNST_SMRY_ID, TRAIN_CNST_SMRY_VRSN_NBR) - 2 columns
Total Columns: 88 source + 6 CDC metadata = 94
...
-- =============================================================================
CREATE OR ALTER TABLE D_BRONZE.SADB.TRAIN_CNST_SMRY (
...
COMMENT = 'Bronze data preservation layer for Train Consist Summary.
Source: Oracle SADB (TRAIN_CNST_SMRY) replicated via IDMC CDC into D_RAW.SADB.TRAIN_CNST_SMRY_BASE.
Data Source Tables: D_RAW.SADB.TRAIN_CNST_SMRY_BASE (88 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.TRAIN_CNST_SMRY_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_TRAIN_CNST_SMRY() | Task D_RAW.SADB.TASK_SP_PROCESS_TRAIN_CNST_SMRY.
Refresh Frequency: Every 5 minutes via Snowflake Task (incremental CDC MERGE).
Primary Key: TRAIN_CNST_SMRY_ID, TRAIN_CNST_SMRY_VRSN_NBR (Composite).';
...
BEGIN
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        USING (
            ...
            FROM D_RAW.SADB.TRAIN_CNST_SMRY_BASE_HIST_STREAM src
        ...
        WHEN NOT MATCHED THEN INSERT (
            ...
            CNST_RAIL_EQPMNT_QTY, SNW_OPERATION_TYPE, SNW_OPERATION_OWNER, SNW_LAST_REPLICATED,
            ...
            src.CNST_RAIL_EQPMNT_QTY, src.SNW_OPERATION_TYPE, src.SNW_OPERATION_OWNER, src.SNW_LAST_REPLICATED,
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'TRAIN_CNST_SMRY', :v_batch_id, 'RECOVERY', :v_start_time, :v_end_time,
    ...
    IF (v_staging_count = 0) THEN
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'TRAIN_CNST_SMRY', :v_batch_id, 'NO_DATA', :v_start_time, :v_end_time,
            0, 0, 0, 0,
...
EXCEPTION
    WHEN OTHER THEN
        ...
        INSERT INTO D_BRONZE.MONITORING.CDC_EXECUTION_LOG (
            ...
            'TRAIN_CNST_SMRY', :v_batch_id, 'ERROR', :v_start_time, :v_end_time,
            0, 0, 0, 0,
            :v_error_msg, CURRENT_TIMESTAMP()
        );
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_TRAIN_CNST_SMRY
...
ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_TRAIN_CNST_SMRY RESUME;
...
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_TRAIN_CNST_SMRY%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRAIN_CNST_SMRY();
