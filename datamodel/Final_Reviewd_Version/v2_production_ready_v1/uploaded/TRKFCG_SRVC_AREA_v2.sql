...
Task         : D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_SRVC_AREA
...
COMMENT = 'Bronze data preservation layer for Track Configuration Service Areas.
Source: Oracle SADB (TRKFCG_SRVC_AREA) replicated via IDMC CDC into D_RAW.SADB.TRKFCG_SRVC_AREA_BASE.
Data Source Tables: D_RAW.SADB.TRKFCG_SRVC_AREA_BASE (26 source columns + 3 SNW metadata).
...
Pipeline Objects: Stream D_RAW.SADB.TRKFCG_SRVC_AREA_BASE_HIST_STREAM | Procedure D_RAW.SADB.SP_PROCESS_TRKFCG_SRVC_AREA() | Task D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_SRVC_AREA.
...
-- =============================================================================
CREATE OR REPLACE TASK D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_SRVC_AREA
...
ALTER TASK D_RAW.SADB.TASK_SP_PROCESS_TRKFCG_SRVC_AREA RESUME;
...
-- SHOW TASKS LIKE 'TASK_SP_PROCESS_TRKFCG_SRVC_AREA%' IN SCHEMA D_RAW.SADB;
-- CALL D_RAW.SADB.SP_PROCESS_TRKFCG_SRVC_AREA();
