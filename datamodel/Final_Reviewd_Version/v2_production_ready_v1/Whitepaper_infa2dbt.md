...
### 6.2 Moderate Mapping — Citibank VCA (LAYERED Strategy)

| Attribute | Value |
|-----------|-------|
| **XML file** | `wf_AP_FF_CITIBANK_VCA.XML` |
| **Sources** | 1 table (t_ap_citibank_vca) with 24 columns |
...
**Generated project structure**:
```
models/m_AP_FF_CITIBANK_VCA/
├── staging/
│   ├── _sources.yml
│   ├── _stg__schema.yml
│   └── stg_citibank_vca.sql          # Column selection + typing
├── intermediate/
│   ├── _int__schema.yml
...
*Document Version 1.0 — Whitepaper. SquadronData, April 2026.*
