...
-- =============================================================================
CREATE TABLE IF NOT EXISTS D_BRONZE.SADB.TRKFCG_SBDVSN (
...
BEGIN
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        USING (
            ...
            FROM D_RAW.SADB.TRKFCG_SBDVSN_BASE src
            LEFT JOIN D_BRONZE.SADB.TRKFCG_SBDVSN tgt 
        ...
        WHEN NOT MATCHED THEN INSERT (
            ...
            ALTRNT_LONG_ENGLSH_NM, ALTRNT_LONG_FRENCH_NM, SNW_OPERATION_TYPE, SNW_LAST_REPLICATED,
            ...
            src.ALTRNT_LONG_ENGLSH_NM, src.ALTRNT_LONG_FRENCH_NM, src.SNW_OPERATION_TYPE, src.SNW_LAST_REPLICATED,
...
WHEN
    SYSTEM$STREAM_HAS_DATA('D_RAW.SADB.TRKFCG_SBDVSN_BASE_HIST_STREAM')
AS
