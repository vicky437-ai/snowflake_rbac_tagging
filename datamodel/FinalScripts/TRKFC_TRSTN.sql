...
-- =============================================================================
CREATE TABLE IF NOT EXISTS D_BRONZE.SADB.TRKFC_TRSTN (
...
BEGIN
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        USING (
            ...
            FROM D_RAW.SADB.TRKFC_TRSTN_BASE src
            LEFT JOIN D_BRONZE.SADB.TRKFC_TRSTN tgt 
...
WHEN
    SYSTEM$STREAM_HAS_DATA('D_RAW.SADB.TRKFC_TRSTN_BASE_HIST_STREAM')
AS
