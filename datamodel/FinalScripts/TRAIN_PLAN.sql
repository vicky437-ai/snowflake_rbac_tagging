...
-- =============================================================================
CREATE TABLE IF NOT EXISTS D_BRONZE.SADB.TRAIN_PLAN (
...
BEGIN
    ...
    IF (v_stream_stale = TRUE) THEN
        ...
        USING (
            ...
            FROM D_RAW.SADB.TRAIN_PLAN_BASE src
            LEFT JOIN D_BRONZE.SADB.TRAIN_PLAN tgt 
                ON src.TRAIN_PLAN_ID = tgt.TRAIN_PLAN_ID
            WHERE tgt.TRAIN_PLAN_ID IS NULL
        ...
        WHEN NOT MATCHED THEN INSERT (
            ...
            TENANT_SCAC_CD, NAMING_OPTION_CD, SNW_OPERATION_TYPE, SNW_LAST_REPLICATED,
            ...
            src.TENANT_SCAC_CD, src.NAMING_OPTION_CD, src.SNW_OPERATION_TYPE, src.SNW_LAST_REPLICATED,
...
WHEN
    SYSTEM$STREAM_HAS_DATA('D_RAW.SADB.TRAIN_PLAN_BASE_HIST_STREAM')
AS
